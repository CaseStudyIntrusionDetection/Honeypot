...
class TestHandleRequest(unittest.TestCase):
    def setUp(self):
        ...
        self.page_location = self.main_page_path.rsplit('/')[-1]
        args = run_args.parse_args(['--page-location', self.page_location])
        args_dict = vars(args)
        ...
        self.handler.tanner_handler_directory.create_data = Mock(return_value=self.request_data)
        self.handler.tanner_handler_directory.submit_data = AsyncMock(return_value=event_result)
        ...
        self.handler.tanner_handler_directory.parse_tanner_response = AsyncMock(
    ...
    def test_create_request_data(self):
        ...
        self.handler.tanner_handler_directory.create_data.assert_called_with(
            self.request, 200)
    ...
    def test_submit_request_data(self):
        ...
        self.loop.run_until_complete(test())
        self.handler.tanner_handler_directory.submit_data.assert_called_with(self.request_data)
    ...
    def test_parse_response(self):
        ...
        self.loop.run_until_complete(test())
        self.handler.tanner_handler_directory.parse_tanner_response.assert_called_with(
